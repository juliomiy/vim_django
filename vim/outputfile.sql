...
CREATE TABLE "customer_extras" (
  "idcustomer_extras" int(11) NOT NULL,
  "idcustomer" int(11) NOT NULL,
...
CREATE TABLE "dispatcher2markets" (
  "iddispatcher2markets" int(11) NOT NULL,
  "idmarkets" int(11) NOT NULL,
  "iddispatcher" int(11) NOT NULL,
  "createtimestamp" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatetimestamp" timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY ("iddispatcher2markets"),
  UNIQUE KEY "dispatchermarkets_uidx" ("idmarkets","iddispatcher"),
...
CREATE TABLE "stylist_extras" (
  "idstylist_extras" int(11) NOT NULL,
  "idstylist" int(11) NOT NULL,
  "facebook" varchar(45) DEFAULT NULL,
  "facebook_token" varchar(45) DEFAULT NULL,
  "twitter" varchar(45) DEFAULT NULL,
...
CREATE TABLE "stylist_verification" (
  "idstylist_verification" int(11) NOT NULL,
  "idstylist" int(11) NOT NULL,
...
/*!50001 DROP VIEW IF EXISTS "servicesbymarket"*/;
/*!50001 CREATE VIEW "servicesbymarket" AS select "s2m"."idmarkets" AS "idmarkets","m"."name" AS "marketname","s"."service" AS "service","s2m"."price" AS "price","s2m"."tax" AS "tax" from (("markets" "m" join "services2markets" "s2m") join "services" "s") where (("s2m"."idservices" = "s"."service") and ("s2m"."idmarkets" = "m"."idmarkets")) */;
...
-- Dump completed on 2014-08-30 19:55:42
